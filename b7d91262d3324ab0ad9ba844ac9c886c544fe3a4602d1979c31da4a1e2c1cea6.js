! function() {
    ...
    class n {
        ...
        runOnResize(t, n) {
            ...
            }), this.items.sort(((t, e) => t.options.priority - e.options.priority)), n.runOnLoad && function(t, n = Number.MAX_VALUE) {
                var i;
    ...
    function o(t) {
        ...
        if (e && n) {
            const i = t.querySelector("iframe"),
                o = t.clientHeight / n;
            i.style.position = "absolute", i.style.width = `${e}px`, i.style.height = `${n}px`, i.style.transform = `scale(${o}) translate(-50%, -50%)`, t.style.aspectRatio = ""
        }
    }! function(e, i, o = t) {
        var r;
        (window.canva_debounceResize = null !== (r = window.canva_debounceResize) && void 0 !== r ? r : new n(o)).runOnResize(e, {
            runOnLoad: !1,
            runOnWidthChange: !0,
            runOnHeightChange: !1,
        ...
        return t.forEach((t => function(t) {
            ...
            t.replaceChildren(e), t.style.position = "relative", t.style.overflow = "hidden", e.style.transformOrigin = "0 0", e.style.top = "50%", e.style.left = "50%"
        }(t))), i = [...t], i
    })().forEach(o)), {
        runOnLoad: !0
    })
